...
<h2>
	...
	<link rel="stylesheet" type="text/css" href="/Public/css/div.css">

	<div id="form">

		<form id="fm" name="register" action="/Public/Waifu/addwaifu.php" method="post">
			...
			Body Type: <br><input type="text" name="bodytype"> <br>
			Personality: <br><input type="text" name="personality"> <br>
